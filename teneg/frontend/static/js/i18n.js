...
const LANG = {
  mn: {
    ...
    /* Sidebar SPA keys */
    'brand.line1': 'Хувийн өнгө',
    'brand.line2': 'Хувцасалт',
    'nav.dashboard': 'Нүүр хуудас',
    'nav.analyze.page': 'Зураг шинжлэх',
    'nav.results': 'Шинжилгээний үр дүн',
    'nav.colors': 'Өнгийн зөвлөгөө',
    'nav.outfits': 'Загварын зөвлөгөө',
    'nav.recent': 'Өмнөх шинжилгээ',
    'nav.about': 'Системийн тухай',
    'analyze.page.title': 'Зураг шинжлэх',
    'analyze.page.sub': 'Хамгийн үнэн зөв үр дүнд хүрэхийн тулд тод, цэвэрхэн нүүрний зураг оруулна уу',
    'results.page.title': 'Шинжилгээний үр дүн',
    'results.page.sub': 'Таны арьсны нарийвчилсан шинжилгээ',
    'colors.page.sub': 'Таны дүр төрхтэй зохицох өнгийн санал',
    'outfits.page.sub': 'Гоо сайхан, хувцас хэрэглэлийн зөвлөмж',
    'recent.page.sub': 'Өмнө хийсэн шинжилгээнүүд',
    'about.page.sub': 'ChromaSense AI — Хувийн өнгийн шинжилгээ',
    'dash.no.title': 'Шинжилгээ хийгдээгүй байна',
    'dash.no.sub': 'Өнгийн профайлаа гаргахын тулд зураг оруулна уу',
    'btn.start': 'Шинжилгээ эхлүүлэх',
    'dash.photo': 'Таны зураг',
    'dash.analysis': 'Шинжилгээний үр дүн',
    'dash.colors': 'Өнгийн палитр',
    'detected.label': 'Илрүүлсэн өнгө',
    'recommend.label': 'Санал болгох',
    'results.view.all': 'Дэлгэрэнгүй үзэх',
    'tab.overview': 'Ерөнхий',
    'tab.skintone': 'Арьсны өнгö',
    'tab.undertone': 'Дотоод өнгö',
    'tab.season': 'Өнгийн улирал',
    'overview.skin': 'Арьсны өнгö',
    'overview.harmony': 'Өнгийн зохицол',
    'overview.best': 'Шилдэг өнгүүд',
    'overview.extra': 'Нэмэлт өнгүүд',
    'overview.avoid': 'Зайлсхийх өнгүүд',
    'results.empty.title': 'Шинжилгээ хийгдээгүй байна',
    'results.empty.sub': 'Эхлээд зураг шинжлэнэ үү',
    'recent.empty.title': 'Өмнөх шинжилгээ алга',
    'recent.empty.sub': 'Шинжилгээний түүх энд хадгалагдах болно',
    'tips.title': 'Зургийн зөвлөгөө',
    'tip.1': 'Байгалийн гэрэл ашиглах',
    'tip.2': 'Нүүрний будаггүй байх',
    'tip.3': 'Камер руу эгц харах',
    'tip.4': 'Нүүрээ бүтэн тод оруулах',
    'why.upload': '✨ Яагаад зураг оруулах вэ?',
    'why.upload.desc': 'AI систем таны арьс, үс, нүдний өнгийг шинжлэн хамгийн тохирох өнгийн палитрыг тодорхойлно.',
    'ut.warm': 'Дулаан',
    'ut.warm.desc': 'Алт, шар, ногоон шар өнгийн дотоод өнгөтэй',
    'ut.cool': 'Сэрүүн',
    'ut.cool.desc': 'Мөнгө, ягаан, цэнхэр өнгийн дотоод өнгөтэй',
    'ut.neutral': 'Нейтрал',
    'ut.neutral.desc': 'Дулаан болон сэрүүн өнгийн хооронд',
    'upload.btn': 'Зураг сонгох',
  },
  en: {
    ...
    /* Sidebar SPA keys */
    'brand.line1': 'Skin & Outfit',
    'brand.line2': 'Advisor',
    'nav.dashboard': 'Home',
    'nav.analyze.page': 'Analyze Photo',
    'nav.results': 'Analysis Results',
    'nav.colors': 'Color Advice',
    'nav.outfits': 'Style Guide',
    'nav.recent': 'History',
    'nav.about': 'About System',
    'analyze.page.title': 'Analyze Photo',
    'analyze.page.sub': 'Upload a clear face photo for the most accurate results',
    'results.page.title': 'Analysis Results',
    'results.page.sub': 'Your detailed skin color analysis',
    'colors.page.sub': 'Color recommendations that suit your look',
    'outfits.page.sub': 'Beauty and styling recommendations',
    'recent.page.sub': 'Previous analyses',
    'about.page.sub': 'ChromaSense AI — Personal Color Analysis',
    'dash.no.title': 'No Analysis Yet',
    'dash.no.sub': 'Upload a photo to generate your color profile',
    'btn.start': 'Start Analysis',
    'dash.photo': 'Your Photo',
    'dash.analysis': 'Analysis Results',
    'dash.colors': 'Color Palette',
    'detected.label': 'Detected Colors',
    'recommend.label': 'Recommended',
    'results.view.all': 'View Details',
    'tab.overview': 'Overview',
    'tab.skintone': 'Skin Tone',
    'tab.undertone': 'Undertone',
    'tab.season': 'Color Season',
    'overview.skin': 'Skin Tone',
    'overview.harmony': 'Color Harmony',
    'overview.best': 'Best Colors',
    'overview.extra': 'Additional Colors',
    'overview.avoid': 'Colors to Avoid',
    'results.empty.title': 'No Analysis Yet',
    'results.empty.sub': 'Analyze a photo first',
    'recent.empty.title': 'No Previous Analyses',
    'recent.empty.sub': 'Your analysis history will appear here',
    'tips.title': 'Photo Tips',
    'tip.1': 'Use natural lighting',
    'tip.2': 'No makeup on face',
    'tip.3': 'Look directly at camera',
    'tip.4': 'Show full face clearly',
    'why.upload': '✨ Why upload a photo?',
    'why.upload.desc': 'Our AI analyzes your skin, hair, and eye color to determine your best color palette.',
    'ut.warm': 'Warm',
    'ut.warm.desc': 'Golden, yellow, and olive undertones',
    'ut.cool': 'Cool',
    'ut.cool.desc': 'Silver, pink, and blue undertones',
    'ut.neutral': 'Neutral',
    'ut.neutral.desc': 'Between warm and cool undertones',
